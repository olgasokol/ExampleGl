...
public class ExampleGLRenderer implements Renderer {
	...
	public void onSurfaceCreated(GL10 gl, EGLConfig config) {
		...
		slides.add(new ExampleGLObject("red", new float[] {1, 0, 0, 1}, new float[] {0, 0, .3f}));
		slides.add(new ExampleGLObject("yellow", new float[] {1, 1, 0, 1}, new float[] {.5f, .5f, 2f}));
		slides.add(new ExampleGLObject("green", new float[] {0, 1, 0, 1}, new float[] {-0.2f, -0.5f, 1f}));
